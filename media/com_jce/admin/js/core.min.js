...
!function($) {
    ...
    $(document).ready(function() {
        ...
        $(".controls").on("click", ".form-field-repeatable-add", function(e) {
            ...
            var e = $(this).parents(".form-field-repeatable-item"), $parent = e.parent(), $item = e.clone(!0);
            $parent.append($item), $parent.find(":input[name]").not('input[type="hidden"]').each(function() {
            ...
            }).trigger("change"), $item.find(":input[name]").val("").trigger("change").removeClass("isdirty"), 
            $item.find("select[name]").find("option:first").prop("selected", !0).parent().trigger("change").removeClass("isdirty"), 
            $item.add(e).find(".field-media-wrapper").each(function() {
                $(this).find(".wf-media-input").removeClass("wf-media-input-converted");
                var value = $(this).find(".wf-media-input").val(), html = $(this).html();
                $(this).html(html), $(this).find(".wf-media-input").val(value), 
            ...
            }), window.SqueezeBox && window.SqueezeBox.assign && window.SqueezeBox.assign($item.find("a.modal").get(), {
                parse: "rel"
            });
