        ...
        FileBrowser.options = {
            ...
            _resetStatus: function() {
                ...
                crumbPath = "", $.each(path, function(i, name) {
                    if (!name) return !0;
                    i && (crumbPath = Wf.String.path(crumbPath, name));
                    i = $('<li title="' + name + '"></li>').on("click", "a", function(e) {
                        e = $(e.target).data("url");
                        self._changeDir(e);
            ...
            serializeItemData: function(item) {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    props.url ? resolve(props) : $(item).hasClass("folder") && $(item).attr("data-url") ? (props.url = self.resolvePath($(item).attr("data-url")), 
                    resolve(props)) : (path = Wf.String.path(self._dir, props.title), 
