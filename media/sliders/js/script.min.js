...
var show=(!$el.hasClass('in')&&!$el.hasClass('active'));if(show){$el.collapse({toggle:true,parent:$el.parent().parent()});$el.collapse('show');$el.closest('div.rl_sliders').find('.rl_sliders-toggle').attr('aria-expanded',false);$el.attr('aria-expanded',true);$el.closest('div.rl_sliders').find('.rl_sliders-body').attr('aria-hidden',true);$('div#'+id).attr('aria-hidden',false);window.dispatchEvent(new Event('resize'));}
