...
$link.addClass('active');});});},initHashLinkList:function(){var self=this;$('a[href^="#"],a[href^="'+this.current_url+'#"],area[href^="#"],area[href^="'+this.current_url+'#"]').each(function($i,el){self.initHashLink(el);});},initHashLink:function(el){var self=this;var $link=$(el);if($link.attr('data-toggle')||$link.hasClass('rl_sliders-toggle')||$link.hasClass('rl_tabs-toggle')||$link.hasClass('rl_tabs-toggle-sm')||$link.hasClass('rl_tabs-link')){return;}
