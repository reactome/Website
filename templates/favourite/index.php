...
<head>
    ...
    <!-- admin -->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/admin/admin.css" />
    <!-- cms -->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/cms.css" />
    <!-- theme -->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/theme.css" />
    <!-- style -->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/style.css" />
    <!-- styles -->
    <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template;?>/css/styles/<?php echo $this->params->get('template_styles'); ?>.css" />
    <!-- Custom: Our custom css -->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/custom.css?v=1.1.1" />
    <!-- Custom: Stylying the autocomplete div-->
    <link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template;?>/css/autocomplete/autocomplete.css" />
    <!-- Custom: rglyph fonts -->
...
<body<?php echo (isset($pageclass) ? ' class="favbody'.htmlspecialchars($pageclass).'"' : ''); ?> ontouchstart="">
      ...
      <div id="fav-navbarwrap" class="favth-visible-xs">
  		...
  		<div id="fav-container" class="fav-container">
            ...
            <!-- Custom: do not show notice in production $app->get('show_notice_mod') != 0) -->
  			<?php if ($this->countModules('notice') && $app->get('show_notice_mod') != 0) { ?>
            ...
            <div class="favth-container">
                ...
                <?php
                    // Custom: remove the button from the notice bar - always visible
        ...
        <?php } ?>
            ...
            <!-- Custom: Icon Library -->
		    <?php if ($this->countModules('icon-lib')) { ?>
                <!-- ICON-LIB -->
                <div id="fav-iconlibwrap">
                    <div class="favth-container">
                        <div class="favth-row">
                            <div class="favth-col-lg-12 favth-col-md-12 favth-col-sm-12 favth-col-xs-12">
                                <?php
                                // Joomla always refers to "index.php" and any page located outside the joomla
                                // router won't find. So calling download.php or search.php won't work.
                                // Workaround: using parameters in the query string and then we include the
                                // that we need.
                                if(isset($_GET["q"])){ // query
                                    include "icon-lib/search.php";
                                } else if (isset($_GET["d"])) { // download
                                    include "icon-lib/download.php";
                                } else { // default
                                    include "icon-lib/index.php";
                                }
                                ?>
                            </div>
                        </div>
		    ...
		    <?php if ($this->countModules('sync-tool')) { ?>
                <!-- ICON-LIB -->
                <div id="fav-synctoolwrap" class="padding0 top30">
                    <div class="favth-container">
                        <div class="favth-row">
                            <div class="favth-col-lg-12 favth-col-md-12 favth-col-sm-12 favth-col-xs-12">
                                <?php
                                        // The menu is protected, the module is protected.
                                        // However the module position can be assigned to a non-protected page.
                                        // So an extra layer of security is added here. The logged user has to be
                                        // member of SyncTool group.
                                        $db     = JFactory::getDBO();
                                        $userid = $user->get('id');
                      ...
                      <?php if (($show_copyright) !=0) : ?>
                        <div id="fav-showcopyright"
                          ...
                          elseif ( $copyright == 4 ):echo ('favth-col-lg-3 favth-col-md-3 favth-col-sm-3 favth-col-xs-12');
                            ...
                            <p>&#0169; <?php echo date('Y'); ?>
                                <!-- Custom: https:// -->
                              <a href="https://<?php echo htmlspecialchars($copyright_text_link);?>" target="_blank">
  ...
  <script src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/js/autocomplete/search-ac.js"></script>
