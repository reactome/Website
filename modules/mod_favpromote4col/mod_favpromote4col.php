	...
	for ($i=1;$i<7;$i++) {
		...
		if ((${'show_column'.$i}) !=0) { ?>
            ...
            <div class="favpromote4col <?php echo $col_class; ?>">
                ...
                <div id="favpromote4col-box<?php echo $i; ?>"
                     class="favpromote4col<?php echo $i; ?>-<?php echo $custom_id; ?> layout-effect"
                    ...
                    <div id="favpromote4col-image<?php echo $i; ?>"
						...
						if(empty(${'image_link'.$i})) { ?>
							...
							<?php } else { ?>
                                <img src="modules/mod_favpromote4col/demo/demo-image<?php echo $i; ?>.jpg"
                                     alt="<?php echo ${'image_alt'.$i}; ?>" />
							<?php } ?>
                    ...
                    <p id="favpromote4col-text<?php echo $i; ?>"
                       style=" height: 150px;
                               overflow:auto;
                    ...
                    <h4 id="favpromote4col-title<?php echo $i; ?>"
