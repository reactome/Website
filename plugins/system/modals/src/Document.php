...
class Document
{
	public static function addHeadStuff()
	{
		...
		RL_Document::script('modals/jquery.modals.min.js', ($params->media_versioning ? '11.5.7' : ''));
		RL_Document::script('modals/script.min.js', ($params->media_versioning ? '11.5.7' : ''));

		if ($params->load_stylesheet)
		{
			RL_Document::style('modals/' . $params->style . '.min.css', ($params->media_versioning ? '11.5.7' : ''));
		}
	}
