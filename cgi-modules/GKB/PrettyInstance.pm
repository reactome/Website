...
sub top_browsing_view {
    ...
    if ($doi_flag) {
        ...
        $out .= qq(<TD data-label="DOI">$doi</TD>);
    } else {
    ...
    $out .= qq(<TD data-label="Author">$authors_str</TD>);
    ...
    $out .= qq(<TD data-label="$class">$tmp</TD>)
	. qq(<TD data-label="$revised_class">$revised_date</TD>)
	. qq(<TD data-label="reviewer">$reviewers_str</TD>)
