...
SQL_SET_AI_EJBBKP="ALTER TABLE rlp_easyjoomlabackup AUTO_INCREMENT = 1;"
SQL_DELETE_SESSIONS="DELETE FROM rlp_session;"
SQL_UPDT_ARTICLE="UPDATE rlp_content SET hits=0,checked_out=0,checked_out_time='0000-00-00 00:00:00',version=1, created_by='${SUPER_USER_ID}',modified_by='${SUPER_USER_ID}',created='2017-01-01 09:00:00',modified='2017-01-01 09:00:00' WHERE catid <> 26;" # not in news category
SQL_UPDT_SITE_LAST_CHECK="UPDATE rlp_update_sites SET last_check_timestamp='0000-00-00 00:00:00';"
SQL_DELETE_UPDATES="DELETE FROM rlp_updates;"
SQL_SET_AI_UPDATES="ALTER TABLE rlp_updates AUTO_INCREMENT = 1;"
SQL_UPDT_TAGS="UPDATE rlp_tags SET hits=0,checked_out=0,checked_out_time='0000-00-00 00:00:00';"
SQL_DEL_UCM_CONTENT="DELETE FROM rlp_ucm_content;"
SQL_SET_AI_UCM_CONTENT="ALTER TABLE rlp_ucm_content AUTO_INCREMENT = 1;"
SQL_DEL_UCM_HISTORY="DELETE FROM rlp_ucm_history;"
SQL_SET_AI_UCM_HISTORY="ALTER TABLE rlp_ucm_history AUTO_INCREMENT = 1;"
SQL_UPDT_CONTENTITEM_TAG_MAP="UPDATE rlp_contentitem_tag_map SET tag_date='0000-00-00 00:00:00';"
SQL_CLEAN_WHAT_IS_NOT_PUBLIC="UPDATE rlp_content SET introtext='' WHERE access <> 1;"
SQL_NORMALISE_MODULES="UPDATE rlp_content SET checked_out=0,checked_out_time='0000-00-00 00:00:00';"
SQL_EJB_CLEAN_TOKEN="UPDATE rlp_extensions SET params='{\"token\":\"\",\"type\":\"1\",\"donation_code\":\"\"}' WHERE extension_id = 10209;"
SQL_REMOVE_BANNER="UPDATE rlp_modules SET published=0,publish_up='0000-00-00 00:00:00',publish_down='0000-00-00 00:00:00',content='' WHERE id = 581;"
SQL_DEL_USER_KEYS="DELETE FROM rlp_user_keys;"
SQL_DEL_POST_INSTALL_MSG="DELETE FROM rlp_postinstall_messages;"
SQL_SET_AI_PIM="ALTER TABLE rlp_postinstall_messages AUTO_INCREMENT = 1;"
SQL_DEL_MSG="DELETE FROM rlp_messages;"
SQL_SET_AI_MSG="ALTER TABLE rlp_messages AUTO_INCREMENT = 1;"
