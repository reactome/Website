    ...
    tinymce.create("tinymce.plugins.AnchorPlugin", {
        init: function(ed, url) {
            ...
            ed.settings.allow_html_in_named_anchor = !0, ed.addCommand("mceInsertAnchor", function(ui, value) {
                ...
                e.keyCode !== VK.BACKSPACE && e.keyCode !== VK.DELETE || self._removeAnchor(e);
                ...
                onclick: function() {
                    ...
                    ed.windowManager.open({
                        ...
                        open: function() {
                            ...
                            ed.getLang("insert", "Insert")), v = self._getAnchor();
                            v && (input.value = v, label = ed.getLang("update", "Update")), 
                        ...
                        buttons: [ {
                            ...
                            id: "remove",
                            onsubmit: function(e) {
                                e.target.disabled || self._removeAnchor();
                            },
                            scope: self
                        }, {
                            ...
                            onsubmit: function(e) {
                                ...
                                value || (e.cancelSubmit = !0), self._insertAnchor(value);
                            },
                            classes: "primary",
                            scope: self
                        } ]
        ...
        _getAnchor: function() {
            var ed = this.editor, n = ed.selection.getNode(), n = ed.dom.getParent(n, "a.mce-item-anchor");
            return ed.dom.getAttrib(n, "name") || ed.dom.getAttrib(n, "id");
        },
        _insertAnchor: function(v) {
            var attrib, ed = this.editor;
