    ...
    tinymce.create("tinymce.themes.AdvancedTheme", {
        ...
        init: function(ed, url) {
            ...
            ed.onInit.add(function() {
                ...
                DOM.get(ed.id + "_parent")), ifr = DOM.get(ed.id + "_ifr"), width = s.width || el.style.width, el = s.height || el.style.height;
                el && DOM.setStyle(ifr, "height", el), width && (DOM.setStyle(e.parentNode, "max-width", width), 
        ...
        createControl: function(n, cf) {
            ...
            return c || ((c = this.controls[n]) ? cf.createButton(n, {
                title: "advanced." + c[0],
                cmd: c[1],
                ui: c[2],
                value: c[3]
        ...
        execCommand: function(cmd, ui, val) {
            cmd = this["_" + cmd];
            return !!cmd && (cmd.call(this, ui, val), !0);
        },
        renderUI: function(o) {
        ...
        _createLayout: function(s, tb, o, p) {
            var ic, lo = s.theme_toolbar_location, sl = s.theme_statusbar_location;
        ...
        _nodeChanged: function(ed, cm, n, co, ob) {
            ...
            cm.setDisabled("outdent", !ed.queryCommandState("Outdent")), s.theme_path && s.theme_statusbar_location) {
                ...
                for (var parents = function(node) {
                    for (var outParents = [], parents = node.parents, i = parents.length, i = 0, l = parents.length; i < l; i++) 1 != (parent = parents[i]).nodeType || function(node) {
                    ...
                    return outParents;
                }(ob), html = "", i = 0, l = parents.length; i < l; i++) {
                    var parent = parents[i], name = parent.nodeName.toLowerCase(), name = {
                        name: name,
                        node: parent,
                        title: name
                    };
