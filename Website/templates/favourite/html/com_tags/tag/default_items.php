	...
	<ul class="category list-striped">
		<?php foreach ($items as $i => $item) : ?>
			...
			<?php endif; ?>
				...
				<?php
				//image
				echo '<img class="fav-tags-img" src="'.$images->image_intro.'">';
				?>
				...
				<p class="readmore">
					<a class="btn" href="<?php echo JRoute::_(TagsHelperRoute::getItemRoute($item->content_item_id, $item->core_alias, $item->core_catid, $item->core_language, $item->type_alias, $item->router)); ?>">

					<?php
					//readmore text
					echo JText::_('TPL_FAV_READ_MORE'); ?>
