    ...
    (function($) {
        ...
        function init(input, settings) {
            ...
            if ( ! settings.textfield) {
                input.addClass('minicolors-hidden');
            }
        ...
        function show(input) {
            ...
            if ( ! input.data('minicolors-initialized') || input.prop('disabled') || minicolors.hasClass('minicolors-focus')) {
                return;
            }
